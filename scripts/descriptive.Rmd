...
vars <- dataset %>% 
    dplyr::select(
        ...
        # Medication
        contains(c("Migraine", "Daily.Preventive", "Rescue.Medications", "topiramate")), headache_severity_cat,
    ) %>% names()
```
...
write.csv(print(CreateTableOne(data = dataset %>% 
                               ...
                               vars = c("medhx_2h_l", "medhx_2q_l", "medhx_6i_l", 
                               ...
                               strata = "eventname", factorVars = c("medhx_2h_l", "medhx_2q_l", "medhx_6i_l", 
                                                                    "medhx_6j_l", "Migraine.Medications_2w", "any_migraine_med_2w", 
                                                                    "Daily.Preventive.medications_2w", "Rescue.Medications_2w", "headache_severity_cat"),
                               includeNA = T)),
...
univariate_headache_1to30 <- vars[1:30] %>%  map_dfr(~get_est(predictor = .x))
...
univariate_headache_91to120 <- vars[91:120] %>%  map_dfr(~get_est(predictor = .x))
univariate_headache_121to145 <- vars[121:length(vars)] %>%  map_dfr(~get_est(predictor = .x))

# Write the results to make sure R's not crashed
# writexl::write_xlsx(univariate_headache_1to30, "../outputs/univariate_headache_1to30_080922.xlsx")
...
# writexl::write_xlsx(univariate_headache_91to120, "../outputs/univariate_headache_91to120_080922.xlsx")
# writexl::write_xlsx(univariate_headache_121toall, "../outputs/univariate_headache_121toall_080922.xlsx")
...
dictionary <- read_xlsx("../data/headache_dictionary_08092022v2.xlsx", sheet = 1) %>%
...
writexl::write_xlsx(univariate_headache_all, "../outputs/univariate_headache_all_08092022.xlsx")
```
