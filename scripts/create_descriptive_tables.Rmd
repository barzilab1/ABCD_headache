...
table1_adj_p <-  round(p.adjust(c(0.74665, 1, 0.00161, 0.00013, 0.94645, 0.58277, 0.95751, 0.00021, 0.017, 0.00001), method = "fdr"), 3)
...
write.csv(
    ...
    "../outputs/etable3_main_values_070523.csv"
)
