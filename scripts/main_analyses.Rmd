...
testRes = cor.mtest(corrs, conf.level = 0.95)
...
# cor_vars <- data_long %>% select(all_of(sig_vars)) # uncomment this if don't use the correlation matrix above (row 71-72)
# cor = cor_auto(cor_vars)
