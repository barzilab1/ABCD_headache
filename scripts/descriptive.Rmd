...
table1_var <- data_wide %>% 
    select(matches(c("age_years__2y", "sex_br", "race", "ethnicity", "poverty_line$", "edu$"))) %>% 
    names()
...
tableS3_var <- data_wide %>% 
    select(matches("age_years__2y|sex_br|race|ethnicity|poverty_line$|edu$|daily_med_2w_ever|rescue_med_2w_ever|PRS")) %>% 
    names()
