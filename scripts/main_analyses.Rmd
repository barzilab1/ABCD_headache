...
# saveRDS(univariate_plot, file = "../data/univariate_plot_abcdgr1_coef_120922.rds")
```
...
# saveRDS(abcd_gr2_weight, file = "../data/abcd_gr2_weight.rds")
```
...
# adj p
round(p.adjust(c(1.279e-11, 0.0005176, 0, 0.0009439, 2.262e-11, 0.08518), method = "fdr"), 3)
```
