...
# Remove variables causing ""not enough finite observations"
cor_1y = cor_auto(cor_vars_1y %>% select(-matches("tbi_ss_[n|a]")))
testRes_1y = cor.mtest(cor_vars_1y %>% select(-matches("tbi_ss_[n|a]")), conf.level = 0.95)
...
# Remove variables causing ""not enough finite observations"
cor_2y = cor_auto(cor_vars_2y %>% select(-matches("tbi_ss_[n|a]")))
testRes_2y = cor.mtest(cor_vars_2y %>% select(-matches("tbi_ss_[n|a]")), conf.level = 0.95)
